...
%}
    ...
    currcfgParam = 'cfgSL_BLOCKLIBS';
    REPORT_FILE_NAME = 'reports';
    REPORT_FILE = [REPORTS_BASE filesep REPORT_FILE_NAME];
    REPORTcurrcfgParam_FILE = [REPORTS_BASE filesep currcfgParam];
    ...
    singleInst = slblocklibcfg.getInstance(cfg);
    singleInst.reload_config(cfg);
    ...
    save(REPORTcurrcfgParam_FILE,'nowtime_str');
    ...
    %     log_len_mismatch_names.print_all('-- printing log_length mismatch model names --');
        ...
        save(REPORT_FILE, 'mdl_counter', 'num_total_sim', 'num_suc_sim', 'num_err_sim', ...
            ...
            '-append');
        slblocklbs = cfg.SL_BLOCKLIBS;
        save(REPORTcurrcfgParam_FILE,'slblocklbs', '-append');
